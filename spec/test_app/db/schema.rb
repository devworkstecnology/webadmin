...
ActiveRecord::Schema.define(version: 20150130140502) do
  ...
  create_table "admin_web_permissions", force: true do |t|
    t.integer  "user_id"
    t.string   "model"
  ...
  add_index "admin_web_permissions", ["user_id"], name: "index_admin_web_permissions_on_user_id", using: :btree
